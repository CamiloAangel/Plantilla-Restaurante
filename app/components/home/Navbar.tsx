    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-zinc-100/50">
      <nav className="container mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex-shrink-0">
          <Link href="/" className="text-3xl font-extrabold text-[#963000] tracking-tight">
            VASTAGO
          </Link>
        </div>
        ...
        <div className="flex-shrink-0">
          <Link
            href="/order"
            className="bg-[#963000] text-white px-8 py-2.5 rounded-full text-lg font-semibold hover:bg-[#963000]/90 transition-all duration-300 shadow-sm"
          >
            Escribenos!
          </Link>
        </div>
