export default function HeroSection() {
  return (
    // Mantenemos el alto exacto para que no haya scroll no deseado
    <section className="relative h-[calc(100vh-4rem)] w-full flex items-center justify-center overflow-hidden">
      
      {/* Fondo: Volvemos al glass blanco brillante */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* El desvanecido blanco esmerilado que querías */}
      ...
      <div className="relative z-10 px-4 md:px-6 w-full max-w-5xl mx-auto text-center flex flex-col items-center">
        ...
        {/* Título - Engordado para móvil. 
            Usamos text-[3.5rem] o text-6xl de base con leading-[0.85] para que se vea masivo. */}
        <h1 className="font-headline text-[3.5rem] sm:text-6xl md:text-7xl lg:text-[7.5rem] font-black text-[#ab2d00] leading-[0.85] tracking-tighter mb-4 md:mb-6 drop-shadow-sm">
          EL ARTE DEL <br /> SABOR URBANO
        </h1>

        {/* Párrafo de vuelta a color negro */}
        ...
        {/* Botones - Ajustados para que en móvil ocupen el ancho bien sin verse amontonados */}
